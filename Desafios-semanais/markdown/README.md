...
| `# Título nível 2`  | <h2>Título nível 1</h2>   |
| `# Título nível 3`  | <h3>Título nível 1</h3>   |
| `# Título nível 4`  | <h4>Título nível 1</h4>   |
| `# Título nível 5`  | <h5>Título nível 1</h5>   |
| `# Título nível 6`  | <h6>Título nível 1</h6>   |
...
| `Exemplo de texto em *itálico*.`               | Exemplo de texto em *itálico*.                |
| `Exemplo de texto em ***negrito e itálico***.` | Exemplo de texto em ***negrito e itálico***.  |
